...
- Unified D1 action authority so a materially superior completed adaptive search root survives contradictory pace-controller advice, and made deadline recovery reuse completed Play evidence or choose the strongest bounded structural Play without fabricating a discard.
