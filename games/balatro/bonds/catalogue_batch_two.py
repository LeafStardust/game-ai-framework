...
def _hand_bond(state:Any,bond_id:str,hand:str,specs:tuple[tuple[str,float,tuple[str,...]],...],thresholds:dict[BondRank,float]|None=None)->BondDevelopment:
 ...
 return _finish(bond_id,parts,thresholds or HAND_THRESHOLDS,target=hand)
...
def evaluate_two_pair_bond(state:Any)->BondDevelopment:return _hand_bond(state,"two_pair","TWO_PAIR",(("Spare Trousers",7.0,("sparetrousers",)),("Square Joker",3.0,("squarejoker",)),("Jolly Joker",2.0,("jollyjoker",)),("Sly Joker",2.0,("slyjoker",)),("Mad Joker",4.0,("madjoker",)),("Clever Joker",4.0,("cleverjoker",))))
...
FOUR_KIND_THRESHOLDS=dict(HAND_THRESHOLDS); FOUR_KIND_POLICIES={BondRank.R1:("recognize_four_kind_specialization",),BondRank.R2:("prefer_deep_rank_concentration",),BondRank.R3:("actively_shape_deck_around_four_kind",),BondRank.R4:("eligible_as_power_engine",),BondRank.R5:("capstone_four_kind_commitment",)}
def evaluate_four_kind_bond(state:Any)->BondDevelopment:return _hand_bond(state,"four_kind","FOUR_OF_A_KIND",(("The Family",7.0,("thefamily",)),),FOUR_KIND_THRESHOLDS)
