...
def evaluate_cash_bond(state: Any) -> BondDevelopment:
    parts = _mechanic_parts(state, (
        (CASH_CHIPS, 5.0, "Cash-to-chips payoff"), (CASH_MULT, 5.0, "Cash-to-Mult payoff"),
        (ROUND_CASH_GROWTH, 4.0, "Round cash growth"), (PASSIVE_CASH, 3.0, "Passive cash"),
        (INTEREST_AMPLIFICATION, 3.0, "Interest amplification"), (UNIQUE_PLANET_CASH, 3.0, "Planet diversity cash"),
        (HELD_FACE_ECONOMY, 2.0, "Held-face economy"), (RANK_NINE_CASH, 3.0, "Nine-card economy"),
    ))
...
def evaluate_face_cards_bond(state: Any) -> BondDevelopment:
    parts = _mechanic_parts(state, (
        (ALL_CARDS_FACE, 6.0, "All-cards-face enabling"), (RETRIGGER_PLAYED_FACE, 5.0, "Face-card retrigger"),
        (FACE_XMULT_FIRST, 4.0, "First-face XMult"), (FACE_CHIPS, 4.0, "Face-card chips"),
        (FACE_MULT, 4.0, "Face-card Mult"), (FACE_CASH, 2.0, "Face-card economy"),
    ))
...
def evaluate_low_ranks_bond(state: Any) -> BondDevelopment:
    parts = _mechanic_parts(state, (
        (LOW_RANK_RETRIGGER, 6.0, "Low-rank retrigger"), (LOW_RANK_TWO_SCALING, 5.0, "Two-rank scaling"),
        (LOW_RANK_FIBONACCI_MULT, 4.0, "Low-rank Fibonacci payoff"), (LOW_RANK_EVEN_MULT, 3.0, "Even-rank Mult"),
