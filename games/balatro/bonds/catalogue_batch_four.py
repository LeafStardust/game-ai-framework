...
def evaluate_tarot_bond(state:Any)->BondDevelopment:
 jokers=list(getattr(state,"jokers",()) or ());vouchers=list(getattr(state,"vouchers",()) or ());parts=_joker_parts(jokers,(("Cartomancer",6.0,("cartomancer",)),("Vagabond",5.0,("vagabond",)),("Hallucination",4.0,("hallucination",)),("Fortune Teller",4.0,("fortuneteller",)),("8 Ball",2.0,("8ball","eightball")),("Superposition",2.0,("superposition",))))
