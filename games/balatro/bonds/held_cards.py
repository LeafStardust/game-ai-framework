...
# it emerges gradually from actual held-card payoff infrastructure.
...
def evaluate_held_cards_bond(state: Any) -> BondDevelopment:
    """Evaluate structural Held Cards development.

    Mime is intentionally excluded. Mime develops Held Retrigger, and the value
    of Mime + Baron/Steel/etc. is represented by Bond synergy/composition rather
    than by giving Mime fake Held Cards quota. Gold Cards and Blue Seals are also
    excluded: being held is only their trigger condition, not their strategic
    identity in this Bond.
    """
