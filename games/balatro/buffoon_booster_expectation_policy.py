...
"""Use bounded public eligible-Joker expectation for unopened Buffoon packs.
...
because pack contents are already sunk after opening. The shared evaluator now uses
bounded build-transition value directly and does not recursively enter D2/D14.
Candidate value is evaluated at the cash remaining after pack purchase; the pack
transaction cost itself is still charged exactly once from the original SHOP state.
...
offer. No independence multiplier or hidden pack content is used.
"""
    ...
    def recommend(self, state, action):
        ...
        return ShopBoosterRecommendation(
            ...
            rationale=(
                ...
                "Buffoon option value uses one-offer bounded public eligible-Joker build-transition expectation",
                f"visible layout offers={offer_count} selections={selection_count}",
                ...
                "full Joker roster remains valid because D9 can execute sell -> reobserve -> select replacement once visible",
                *expectation.rationale,
