...
def main() -> int:
    try:
        ...
        with LiveMemoryBalatroObserver() as observer:
            ...
            if not node:
                raise RuntimeError("unable to read cash-out owner node")
        ...
        print("Live ROUND_EVAL cash-out geometry diagnostic -> FAIL")
        print(f"Reason -> {error}")
        print("Mouse input sent -> False")
        print("Process writes/injection -> False")
        return 2

    print("Live ROUND_EVAL cash-out geometry diagnostic -> PASS")
    ...
    if button != EXPECTED_BUTTON or control_id != EXPECTED_ID:
        print("Cash-out identity guard -> FAIL")
        print(
            "Expected -> "
    ...
    print("Cash-out identity guard -> PASS")
    ...
    if _complete_geometry(node_vt):
        ...
        print("Cash-out geometry readiness -> FAIL")
    ...
    print("Cash-out geometry readiness -> PASS")
    print("Cash-out click sent -> False")
    return 0
