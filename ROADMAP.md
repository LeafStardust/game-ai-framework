...
- [ ] Value Planets by expected future hand frequency, marginal level gain, build synergy and feasibility; suppress speculative upgrades such as unsupported early Straight Flush/Neptune lines.
...
- [ ] Calibrate D3/D8/D9/D10/D11/D12/D14 acquisition, sale, reroll and pack thresholds around survival, build value and economy.
- [ ] Model run-wide voucher value plus reserve/interest breakpoints, including observable voucher-modified caps or thresholds.
