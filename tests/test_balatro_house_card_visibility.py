...
def _bordered_back_image(*, width=80, height=120, border=8):
    pixels = bytearray()
...
def test_house_visibility_rejects_card_back_with_bright_neutral_border():
    assert is_face_up_image(_bordered_back_image()) is False
