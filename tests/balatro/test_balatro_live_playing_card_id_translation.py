...
def test_live_translator_exact_playing_card_id_normalizes_integral_lua_number():
...
def test_live_translator_exact_playing_card_id_preserves_missing_identity_without_inventing_one():
...
def test_live_translator_exact_playing_card_id_rejects_inexact_or_invalid_identity(value):
